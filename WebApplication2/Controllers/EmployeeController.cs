...
namespace WebApplication2.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public JsonResult GetPositions(Department department)
        {
            ...
            {
                { Department.IT, new List<string> { "Разработчик", "Сисадмин", "Сетевик" }},
                { Department.Кадры, new List<string> { "Кадровик", "Начальник кадров", "Поиск талантов" } },
                { Department.Продажи, new List<string> { "Ведущий продажник", "Продажник", "Главбух" } },
                { Department.Администрация, new List<string> { "Руководитель", "Помошник руковотеля", "Ресепционист" } }
            };
